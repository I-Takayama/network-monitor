...
## 概要
本ツールはネットワーク監視およびセキュリティ対策を目的として開発しました。
...
ネットワークおよびセキュリティ分野に関心があり、  
低レイヤからシステムを理解し、設計・実装まで一貫して行う力を強みとしています。

本プロジェクトでは、socket通信・マルチスレッド・排他制御・HTTPサーバ実装などを通じて、  
実用的な監視システムを自ら設計・開発しました。

今後は、ネットワークおよびインフラ領域において、  
システムの信頼性や安全性を支えるエンジニアを目指しています。
